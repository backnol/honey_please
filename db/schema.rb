...
ActiveRecord::Schema.define(version: 20140712021954) do
  ...
  add_index "relationships", ["honey_id"], name: "index_relationships_on_honey_id", using: :btree
  ...
  add_index "tasks", ["points"], name: "index_tasks_on_points", using: :btree
